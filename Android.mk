...
include $(CLEAR_VARS)
LOCAL_MODULE := qInstaFailAccuracy_0_1_0
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp/' -isystem 'extern' -'extern/codegen' -I'./shared' -I'./extern' -I'./extern/codegen/include' -DID='"qInstaFailAccuracy"' -DVERSION='"0.1.0"'
